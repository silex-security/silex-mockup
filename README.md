...
- **What changed on 9/14:** click **◆ 9/14 changes** in the top bar. It lists every change, jumps to it, and outlines the changed elements on the page. The same list, page by page, is in [`CHANGES.md`](CHANGES.md).
